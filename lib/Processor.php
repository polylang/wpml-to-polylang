...
class Processor {
    ...
    protected function prepare_for_import() {
        ...
        $term_ids = NULL; unset($term_ids); time_nanosleep(0, 10000000); // Free memory
    ...
    private function _import_wpml_translations() {
        ...
        // Cleanup
        $icl_translations = NULL; unset($icl_translations);
        time_nanosleep(0, 10000000); // Free memory
    }
    ...
    private function _get_term_ids_with_correspondence() {
        ...
        */
        ...
        $_taxonomies = NULL; unset($_taxonomies); time_nanosleep(0, 10000000); // Free memory
        ...
        // Cleanup
        $taxonomies = NULL; unset($taxonomies);
        $_tmp_term_ids = NULL; unset($_tmp_term_ids);
        time_nanosleep(0, 10000000); // Free memory
    ...
    private function _process_post_term_translations( $icl_translations ) {
        ...
        foreach ( array( 'post', 'term' ) as $type ) {
            ...
            $terms = NULL; unset($terms); time_nanosleep(0, 10000000); // Free memory
